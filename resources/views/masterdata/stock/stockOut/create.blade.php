...
@section('title', 'Add Stock Out'){{-- ubah --}}
@section('content')
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add Stock Out</h5>{{-- ubah --}}
                            <span>Add, edit and delete stock out</span>{{-- ubah --}}
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('stockOut.store') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-sm-6">
