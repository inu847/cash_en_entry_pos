			...
			<div class="card">
				<div class="card-header row">
					<div class="col col-sm-2">
						<a href="{{ route('katalog.create') }}" class="btn btn-sm btn-primary btn-rounded">Add katalog</a>
					</div>
						...
						<tbody>
							@foreach ($data as $item)
								<tr>
									...
									<td>{{ katalogStatus($item->status) }}</td>
									<td>{{ katalogType($item->type) }}</td>
									<td>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modal_update_dataLabel">Update Katalog</h5>
