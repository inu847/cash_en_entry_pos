			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>View, delete and update Level</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="card">
				<div class="card-header row">
					<div class="col col-sm-2">
						<a href="{{ route('emLevel.create') }}" class="btn btn-sm btn-primary btn-rounded">Add Level</a>
					</div>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modal_update_dataLabel">Update Employee Level</h5>
