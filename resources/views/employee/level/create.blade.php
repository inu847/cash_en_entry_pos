...
@section('title', 'Add Employee Level')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add Employee Level</h5>
                            <span>Add new Level in Employee</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="" type="number" class="form-control" name="from" value="" placeholder="Enter Level" required="">
                                    <div class="help-block with-errors"></div>
                                    </div>
                                    </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="" type="number" class="form-control" name="until" value="" placeholder="Enter Level" required="">
                                    <div class="help-block with-errors"></div>
                                    </div>
