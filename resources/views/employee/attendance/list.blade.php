			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>View, delete and update Employee Attendance</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="card">
				<div class="card-header row">
					<div class="col col-sm-2">
						<a href="{{ route('emAttendance.create') }}" class="btn btn-sm btn-primary btn-rounded">Add Employee Attendance</a>
					</div>
