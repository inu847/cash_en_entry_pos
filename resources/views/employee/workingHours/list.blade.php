...
@section('title', 'Employee Working Hours')
@section('content')
		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Employee Working Hours</h5>
						<span>View, delete and update Employee Working Hours</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="card">
				<div class="card-header row">
					<div class="col col-sm-2">
						<a href="{{ route('emWorkingH.create') }}" class="btn btn-sm btn-primary btn-rounded">Add Working Hours</a>
					</div>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modal_update_dataLabel">Update Employee Working Hours</h5>
